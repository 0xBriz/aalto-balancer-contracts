...
abstract contract BaseGaugeFactory is IBaseGaugeFactory {
    ILiquidityGaugeV2 private _gaugeImplementation;

    mapping(address => bool) private _isGaugeFromFactory;

    event GaugeCreated(address indexed gauge);

    constructor(ILiquidityGaugeV2 gaugeImplementation) {
     ...
     */
    function getGaugeImplementation() public view returns (ILiquidityGaugeV2) {

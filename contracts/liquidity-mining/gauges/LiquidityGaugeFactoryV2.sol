...
import "../../interfaces/liquidity-mining/IBaseGaugeFactory.sol";
import "../../interfaces/liquidity-mining/ILiquidityGaugeV2.sol";

import "../../solidity-utils/openzeppelin/Clones.sol";

import "../BaseGaugeFactory.sol";

contract LiquidityGaugeFactoryV2 is BaseGaugeFactory {
    constructor(ILiquidityGaugeV2 gauge) BaseGaugeFactory(gauge) {
    ...
    function create(address pool, uint256 relativeWeightCap) external override returns (address) {
        ...
        ILiquidityGaugeV2(gauge).initialize(pool, relativeWeightCap);
        return gauge;
    }
}

...
import "../../interfaces/liquidity-mining/IFeeDistributor.sol";
import "../../interfaces/liquidity-mining/IVotingEscrow.sol";
...
contract FeeDistributor is IFeeDistributor, ReentrancyGuard {
     ...
     * @param token - The ERC20 token address to query.
     */
    function getUserTokenTimeCursor(address user, IERC20 token)
        external
        view
        override
        returns (uint256)
     ...
     */
    function depositTokens(IERC20[] calldata tokens, uint256[] calldata amounts)
        external
        override
        nonReentrant
    {

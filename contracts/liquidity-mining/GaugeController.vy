...
@external
def set_staking_admin(_admin: address):
    assert _admin != ZERO_ADDRESS, "Admin not provided"
    assert msg.sender == AUTHORIZER_ADAPTOR or  msg.sender == self.stakingAdmin, "Not allowed"

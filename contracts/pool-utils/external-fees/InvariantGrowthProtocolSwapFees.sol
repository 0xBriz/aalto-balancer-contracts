...
library InvariantGrowthProtocolSwapFees {
    ...
    function getProtocolOwnershipPercentage(
        ...
        if ((supplyGrowthRatio >= invariantGrowthRatio) || (protocolSwapFeePercentage == 0))
            return 0;
    ...
    function calcDueProtocolFees(
        ...
        return
            ExternalFees.bptForPoolOwnershipPercentage(currentSupply, protocolOwnershipPercentage);
    }
}

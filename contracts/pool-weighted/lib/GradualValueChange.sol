...
library GradualValueChange {
    ...
    function resolveStartTime(uint256 startTime, uint256 endTime)
        internal
        view
        returns (uint256 resolvedStartTime)
    {
     ...
     */
    function _calculateValueChangeProgress(uint256 startTime, uint256 endTime)
        private
        view
        returns (uint256)
    {

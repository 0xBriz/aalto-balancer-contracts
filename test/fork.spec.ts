...
//     console.log((await stables.period_timestamp(3907)).toNumber());
//     console.log((await wrapped.period_timestamp(3158)).toNumber());
//     console.log((await ashare.period_timestamp(5918)).toNumber());
//     console.log((await maxi.period_timestamp(2516)).toNumber());

//     // const slope = await gaugeController.vote_user_slopes(
//     //   "0x3fF07607c5C8C619C69b1fd4C08aebF069AA10c7",
//     //   stablesGauge
//     // );
//     // console.log("power: " + slope.power.toNumber());
//     // console.log("slope: " + formatEther(slope.slope));
//     // console.log("end: " + new Date(slope.end.toNumber() * 1000).toLocaleString());

//     // await runForGauges(async (addy) => {
//     //   await gaugeController.checkpoint_gauge(addy);
//     // });

//     // await gaugeController.checkpoint_gauge(veGauge);
//     // await logWeights(epochStamp);
...
//     // for (const guser of blueUsers) {
//     //   console.log(guser);
//     //   console.log(formatEther(await gauge.claimable_tokens(guser)));
//     //   await balMinter.connect(signer).mint(blueMaxiGauge);
//     //   console.log(formatEther(await gauge.claimable_tokens(user)));
//     // }
...
//     // await gaugeController.change_gauge_weight(aeqGauge, 1000);
//     // await gaugeController.checkpoint_gauge(aeqGauge);
//     // console.log(formatEther(await gaugeController.gauge_relative_weight(aeqGauge, epochStamp)));
//     // console.log(formatEther(await gauge.claimable_tokens(user)));
//     // await balMinter.connect(signer).mint(aeqGauge);
//     //console.log(formatEther(await gauge.claimable_tokens(user)));
//     //await gaugeController.checkpoint_gauge(aeqGauge);
//     // await helpers.time.increase(DAY * 7);
//     // console.log(
//     //   formatEther(
//     //     await gaugeController.gauge_relative_weight(aeqGauge, await helpers.time.latest())
//     //   )
//     // );
//     //console.log(formatEther(await gauge.claimable_tokens(user)));

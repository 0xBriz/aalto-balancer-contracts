...
const contractSettings: ContractSettings = {
  ...
  "../contracts/pool-weighted/LiquidityBootstrappingPoolFactory.sol": {
    version: "0.7.1",
    runs: 200,
  },
  "../contracts/pool-weighted/managed/ManagedPoolFactory.sol": {
    version: "0.7.1",
    runs: 200,
  },
  "../contracts/pool-weighted/managed/ManagedPool.sol": {
    version: "0.7.1",
    runs: 200,
  },
  "../contracts/pool-weighted/test/MockManagedPool.sol": {
    version: "0.7.1",
    runs: 200,
  },
};
